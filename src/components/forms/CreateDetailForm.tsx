...
export default function CreateDetailForm({onCreate} : CreateDetailFormProps) {
                            ...
                            <div className="create-detail left-field name-field">
                                ...
                                <Controller
                                    ...
                                    render={({ field }) => (
                                        <TextField
                                            id="text-field"
                                            sx = {{backgroundColor: 'white' , borderRadius: '10px', mt: '8px', width: '99%',
                                    ...
                                    <Controller
                                        ...
                                        render={({ field }) => (
                                            <TextField
                                                ...
                                                sx = {{backgroundColor: 'white' , borderRadius: '10px', mr: '0', mt: '8px', width: '96%',
                                                    "& .MuiOutlinedInput-root.Mui-focused .MuiOutlinedInput-notchedOutline":
                                                        {borderColor: 'white' ,borderRadius: '10px'}}}
                                            />
                                        )} />
                                        ...
                                        render={({ field }) => (
                                            <TextField
                                                ...
                                                sx = {{backgroundColor: 'white' ,
                                                    borderRadius: '10px', mt: '8px', width: '97%',
                                                    "& .MuiOutlinedInput-root.Mui-focused .MuiOutlinedInput-notchedOutline":
                                                        {borderColor: 'white' ,borderRadius: '10px'}}}
                                            />
                                        )} />
                                    ...
                                    <Controller
                                        ...
                                        render={({ field }) => (
                                            <TextField
                                                ...
                                                sx = {{backgroundColor: 'white' , borderRadius: '10px', mt: '8px', width:'97%',
                                                    "& .MuiOutlinedInput-root.Mui-focused .MuiOutlinedInput-notchedOutline": {borderColor: 'white' ,borderRadius: '10px',
                                                    }}}
                                            />
                                        )} />
