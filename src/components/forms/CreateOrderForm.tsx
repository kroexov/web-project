import {Box, TextField, Button, InputAdornment, FormControlLabel, Checkbox} from '@mui/material';
...
export default function CreateOrderForm({onCreate} : CreateOrderFormProps  ) {
    ...
    return (//className={useState() ? "modal__content active" : "modal__content"}>
        <Box className="create-order order">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="create-order request">
                <div className="create-order form">
                                ...
                                <Controller
                                    ...
                                    render={({ field }) => (
                                        <TextField
                                            ...
                                            sx = {{backgroundColor: 'white' , borderRadius: '10px', mt: '8px',
                                                "& .MuiOutlinedInput-root.Mui-focused .MuiOutlinedInput-notchedOutline": {borderRadius: '10px',
                                                }}}
                                        />
                                    )} />
                            </div>
                                ...
                                <Controller
                                    ...
                                    render={({ field }) => (
                                        <TextField
                                            ...
                                            sx = {{backgroundColor: 'white' , borderRadius: '10px', mt: '8px',
                                                "& .MuiOutlinedInput-root.Mui-focused .MuiOutlinedInput-notchedOutline": {borderColor: 'white' ,borderRadius: '10px',
                                                }}}
                                        />
                                    )} />
                            </div>
                                ...
                                <Controller
                                    ...
                                    render={({ field }) => (
                                        <TextField
                                            ...
                                            sx = {{backgroundColor: 'white' , borderRadius: '10px', mr: '50px', mt: '8px',
                                                "& .MuiOutlinedInput-root.Mui-focused .MuiOutlinedInput-notchedOutline": {borderColor: 'white' ,borderRadius: '10px',
                                                }}}
                                        />
                                    )} />
                                ...
                                <Controller
                                    ...
                                    render={({ field }) => (
                                        <TextField
                                            ...
                                            sx = {{backgroundColor: 'white' , borderRadius: '10px', m:'2', mt: '8px',
                                                "& .MuiOutlinedInput-root.Mui-focused .MuiOutlinedInput-notchedOutline": {borderColor: 'white' ,borderRadius: '10px',
                                                }}}
                                        />
                                    )} />
                    ...
                    <div className="create-order right-field">
                        <div className="create-order right-field first-group">
                            <Typography className="create-order right-field detail-name" sx={{color: 'black', mt: '8px'}}>
                                Ваша деталь: Имя детали
                            </Typography>
                            <Typography className="create-order right-field amount" sx={{color: 'black', mt: '8px'}}>
                                ...
                                <Controller
                                    ...
                                    render= {({ field }) => (
                                        <TextField
                                            ...
                                            multiline
                                            rows={5}
                                            sx = {{backgroundColor: 'white' , borderRadius: '10px', width: '190%', mt: '8px',
                                                "& .MuiOutlinedInput-root.Mui-focused .MuiOutlinedInput-notchedOutline": {borderColor: 'white' ,borderRadius: '10px'
                                                }}}
                                        />
                                    )} />
                ...
                <div className="create-order steps-button-field">
                    ...
                    <Button
                        ...
                        onClick={() => {
                            fetch('http://localhost:8080/bar').then(response => alert(response.body))
                        }
                        }
                    >
                        Далее
